...
<div>
   ...
   <h2 class="fw1 f2 fw1">Bio</h2>
      <p class="lh-copy fw1">Evan has been integrating public interest and social responsibility into his design work for over 10 years. He is a Project M alumnus, was named a League of Women Voters Rising Star, was a co-founding partner in Houston’s first B-Corporation, and was named one of the “Best in Texas” by AIGA in 2014.</p>
    
    
    </div>

    <div className="fl w-100 w-40-l pa5-l pa4 mh25" >
    <h2 class="fw1 f2">Recent Articles</h2>
